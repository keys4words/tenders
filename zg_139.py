...
from config.conf_139 import from_email, password, to_emails, bcc


BASE_URL = 'https://zakupki.gov.ru'
BASE_DIR = os.path.abspath(os.path.dirname(__file__))
DB_PATH = os.path.join(BASE_DIR, 'db', 'zg_139.db')

FILE_WITH_KW = os.path.join(BASE_DIR, 'keywords', 'zg_139.txt')
...
def set_logger():
    root_logger = logging.getLogger('zg_139')
    log_file = os.path.join(BASE_DIR, 'logs', 'zg_139.log')
...
sending_email(save_results(res=res, fileprefix='_zg_139'), '139 zakupki-gov by words', to_emails=to_emails)
